...
std_range = np.arange(0, 0.2, 0.01)
acc_FGSM = []
acc_SaliencyMap = []
acc_DeepFool = []
acc_CW = []
    ...
    for data in testloader:
        ...
        if count>10:
            ...
            for i in range(len(adversarials_SaliencyMap)):
                adversarials_SaliencyMap[i] = skimage.util.random_noise(adversarials_SaliencyMap[i], 
                                                                 mode = 's&p', seed = None, 
                                                                 clip = True, amount=j)
            ...
            for i in range(len(adversarials_DeepFool)):
                adversarials_DeepFool[i] = skimage.util.random_noise(adversarials_DeepFool[i], 
                                                                 mode = 's&p', seed = None, 
                                                                 clip = True, amount=j)
